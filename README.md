...
<a href="https://aws.amazon.com/" target="_blank" rel="noreferrer" 
   style="display:inline-flex;align-items:center;gap:10px;padding:6px 12px;border-radius:8px;
          background:#f7f7f7;border:1px solid #ddd;text-decoration:none;color:#000;">
  ...
  <span style="font-family:system-ui, sans-serif;font-size:15px;font-weight:600;">AWS</span>
</a>
